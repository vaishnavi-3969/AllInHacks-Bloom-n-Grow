...
const Landing = () => {
  ...
  return (
    <motion.div
      ...
      className="bg-green-900 text-white min-h-screen flex flex-col justify-center items-center"
    >
      <div className="max-w-3xl text-center">
        ...
        <div className="flex justify-center mb-12">
          <button
            ...
            className="bg-green-500 hover:bg-green-600 text-lg md:text-xl font-bold py-2 px-6 rounded-full mr-4 transition duration-300 ease-in-out transform hover:scale-105"
          >
            Sign Up
          </button>
          <button
